...
func (r *Repository) CreatePosts(posts []*view.PostCreate, thread *model.Thread) (model.Posts, error) {
...
func (r *Repository) chunkPosts(posts []*view.PostCreate) [][]*view.PostCreate {
	chunked := make([][]*view.PostCreate, 0)
...
func (r *Repository) createPostsChunk(forum *model.Forum, thread *model.Thread, posts []*view.PostCreate, created time.Time) ([]int, error) {
	columns := 8
